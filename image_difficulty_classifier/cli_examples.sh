# Example 1: Train with default settings (CLIP MLP + ViT-B-32 + OpenAI weights)
# Output will automatically go to: output_CLIP_MLP_VIT_B_32_openai
...
# Output will go to: output_CLIP_LINEAR_VIT_B_32_openai
python -m image_difficulty_classifier.train \
